...
// HasOrdercompany applies the HasEdge predicate on the "ordercompany" edge.
func HasOrdercompany() predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OrdercompanyTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, OrdercompanyTable, OrdercompanyColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasOrdercompanyWith applies the HasEdge predicate on the "ordercompany" edge with a given conditions (other predicates).
func HasOrdercompanyWith(preds ...predicate.Order) predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OrdercompanyInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, OrdercompanyTable, OrdercompanyColumn),
		)

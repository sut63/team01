...
// HasDoctorprescription applies the HasEdge predicate on the "doctorprescription" edge.
...
// HasDoctorprescriptionWith applies the HasEdge predicate on the "doctorprescription" edge with a given conditions (other predicates).

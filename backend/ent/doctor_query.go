...
// QueryDoctorprescription chains the current query on the doctorprescription edge.
...
// the "doctorprescription" edge. The optional arguments used to configure the query builder of the edge.

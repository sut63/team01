...
func (pu *PaymentUpdate) SetPay(s string) *PaymentUpdate {
	pu.mutation.SetPay(s)
	return pu
}

// AddBillIDs adds the Bills edge to Bill by ids.
func (pu *PaymentUpdate) AddBillIDs(ids ...int) *PaymentUpdate {
	pu.mutation.AddBillIDs(ids...)
	return pu
}

// AddBills adds the Bills edges to Bill.
func (pu *PaymentUpdate) AddBills(b ...*Bill) *PaymentUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
func (pu *PaymentUpdate) RemoveBillIDs(ids ...int) *PaymentUpdate {
	pu.mutation.RemoveBillIDs(ids...)
	return pu
}

// RemoveBills removes Bills edges to Bill.
func (pu *PaymentUpdate) RemoveBills(b ...*Bill) *PaymentUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
func (pu *PaymentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Pay(); ok {
...
// SetPay sets the pay field.
func (puo *PaymentUpdateOne) SetPay(s string) *PaymentUpdateOne {
	puo.mutation.SetPay(s)
	return puo
}

// AddBillIDs adds the Bills edge to Bill by ids.
func (puo *PaymentUpdateOne) AddBillIDs(ids ...int) *PaymentUpdateOne {
	puo.mutation.AddBillIDs(ids...)
	return puo
}

// AddBills adds the Bills edges to Bill.
func (puo *PaymentUpdateOne) AddBills(b ...*Bill) *PaymentUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// RemoveBillIDs removes the Bills edge to Bill by ids.
func (puo *PaymentUpdateOne) RemoveBillIDs(ids ...int) *PaymentUpdateOne {
	puo.mutation.RemoveBillIDs(ids...)
	return puo
}

// RemoveBills removes Bills edges to Bill.
func (puo *PaymentUpdateOne) RemoveBills(b ...*Bill) *PaymentUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
func (puo *PaymentUpdateOne) sqlSave(ctx context.Context) (pa *Payment, err error) {
	...
	if value, ok := puo.mutation.Pay(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: payment.FieldPay,
